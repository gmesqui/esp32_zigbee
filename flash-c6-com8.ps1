# Flash an already-built ESP32-C6 Super Mini image on COM8, then open monitor.
param(
    [switch]$ManualBoot
)
...
try {
    esptool.py --chip esp32c6 -p COM8 -b 115200 --before $beforeReset --after hard_reset write_flash "@flash_args"
